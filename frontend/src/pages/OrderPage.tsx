          ...
          <div className="lg:col-span-2 flex flex-col gap-3">
            {cart.items.map((item: CartItem) => {
              ...
              return (
                <div
                  key={item.productId}
                  className={`group bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-center gap-4 transition-opacity duration-200 ${
